...
Application
    Test-extendedMomentInversionRealizability.C

Description
    Test the extendedMomentInversionRealizability class and its subclasses.
...
int main(int argc, char *argv[])
{
    ...
    Info << "Testing extendedMomentInversionRealizability\n" << endl;
...
//    moments[6] = 15.75531;
    ...
    autoPtr<extendedMomentInversionRealizability> EQMOM
    (
        extendedMomentInversionRealizability::New
        (
    ...
    Info<< "ExecutionTime = " << executionTime.elapsedCpuTime() << " s" << nl << endl;
